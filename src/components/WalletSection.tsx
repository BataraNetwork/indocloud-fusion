          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold">847.2 BTR</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold">500.0 BTR</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold">47.3 BTR</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold">127.4 BTR</p>
          ...
          <CardContent className="space-y-4">
            <div className="p-4 rounded-lg bg-gradient-to-r from-cyber-purple/10 to-cyber-cyan/10 border border-accent/30">
              <div className="flex justify-between items-start mb-3">
                <div>
                  ...
                  <p className="text-2xl font-bold">500.0 BTR</p>
                </div>
              ...
              <p className="text-sm text-muted-foreground">
                Earn rewards by securing the network. Minimum stake: 100 BTR
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-success">47.3 BTR</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-cyber-cyan">2.1 BTR (6h)</span>
              </div>
            </div>
